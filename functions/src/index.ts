...
export const jobUpdatePersistenceGames = functions.runWith({timeoutSeconds: 540, memory: "1GB"}).region("europe-west6").pubsub.schedule("00 00 * * *").timeZone("Europe/Zurich").onRun(updatePersistenceJobGames); // monday 9:00
